...
//    @State private var isGrowthComplete = false
//    @State private var showPlantView = true
//    
//    var body: some View {
//        VStack {
//            if showPlantView {
//                // Plant growth view with automatic animation
//                PlantGrowthView(isGrowthComplete: $isGrowthComplete,
//                               growthDuration: 10.0,
//                               autoStart: true)
...
//            }
//            
//            Text(isGrowthComplete ? "Your plant is fully grown!" : "Growing...")
//                .padding()
//            
//            Button(action: {
...
//                showPlantView = false
//                
//                // Re-create the view to start fresh
